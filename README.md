...
During your challenge, you will be pulled aside by a PM for a 5 minute interview. During this interview, you will be expected to answer the following three questions:
  ...
  * 1. What is a computer and how does it work?
  ...
  A modern computer is billions of transistors. A transistors can be thought of as a byte that can store a state of on or off. Using tons of transitors comparators, adders ect can be made and all of this put together can make a computer. 


  * 2. What is an array and how does it work?

  A array is a fixed chunk of memory that holds a list of indexed values.

  

  * 3. What is a hash table and how does it work?

  A simple summary of a hash table is an array of linked lists with the index of the array being generated by hashing the key.
